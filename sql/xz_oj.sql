...
) ENGINE = InnoDB AUTO_INCREMENT = 1780191399735832578 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '题目' ROW_FORMAT = Dynamic;
...
CREATE TABLE `question_submit`  (
  ...
  INDEX `idx_userId`(`userId` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1779871751769178115 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '题目提交' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1777316457193254914 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户' ROW_FORMAT = Dynamic;
